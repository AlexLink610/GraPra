...
void blit_depth(const cppgl::Texture2D& depth, const cppgl::Texture2D& col);
void blit_depth(const std::shared_ptr<cppgl::Texture2D>& depth, const std::shared_ptr<cppgl::Texture2D>& col);
