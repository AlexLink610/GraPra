...
class Player {
	...
	cppgl::Timer movement_timer;
    cppgl::Timer particle_timer;
    cppgl::Timer wobble_timer;
...
public:
	...
	bool respawning;
	int frags;
    static std::vector<cppgl::Drawelement> prototype;
};
...
public:
	...
	glm::vec2   uv_offset;
    bool        exploding;
    cppgl::Timer       explo_timer;
    std::vector<glm::vec3> explo_rot_axis;
    std::vector<float> explo_rot_angle;
    std::vector<glm::vec3> explo_translation;
	static cppgl::Material wood_material;
	static std::vector<cppgl::Material> stone_materials;
	static std::vector<cppgl::Drawelement> prototype_idle;
	static std::vector<cppgl::Drawelement> prototype_scatter;
};
...
class Board {
	...
	// cppgl::Timer and flag for the camera explosion shake
	cppgl::Timer camera_shake_timer;
	bool camera_shake;
